            ...
            <Layout>
                        ...
                        <Row>
                            ...
                            <Col xs={24} sm={24} md={24} lg={12} xl={12} xxl={12} className={cx('wrap-text')}>
                                ...
                                <Typography.Paragraph className={cx('text')}>
                                    Porta semper lacus cursus, feugiat primis ultrice in ligula risus lorem auctor
                                    tempus feugiat dolor lacinia cubilia curae integer congue leo metus, eu mollislorem
                                    primis in orci integer metus mollis faucibus. An enim nullam tempor sapien gravida
                                    donec pretium and ipsum porta justo integer at velna vitae auctor integer congue
                ...
                <Row justify="center">
                    <Col xs={22} sm={22} md={18}>
                        <Row>
                            <Col xs={24} sm={24} md={24} lg={12} xl={12} xxl={12} className={cx('wrap-text')}>
                                <Typography.Text className={cx('text-title')}>BEST PRACTICES</Typography.Text>
                                <Typography.Title className={cx('main-title')}>
                                    Clinic with Innovative Approach to Treatment
                                </Typography.Title>
                                <Typography.Paragraph className={cx('text')}>
                                    An enim nullam tempor sapien gravida donec enim ipsum blandit lorem porta justo
                                    integer in odio velna vitae auctor integer congue magna at pretium purus pretium
                                    ligula rutrum itae laoreet augue posuere and curae integer congue leo metus mollis
                                    primis
                                </Typography.Paragraph>
                                <Typography.Text className={cx('title')}>Highest Quality Care</Typography.Text>
                                <List
                                    split={false}
                                    dataSource={data}
                                    renderItem={(item) => (
                            ...
                            <Col xs={24} sm={24} md={24} lg={12} xl={12} xxl={12} className={cx('wrap-img')}>
                                <img src={img04} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                            </Col>
                        </Row>
                    </Col>
                </Row>
                ...
                <Row justify="center">
                    <Col span={24}>
                        <Row>
                            ...
                            >
                                <Typography.Text className={cx('text-title')}>QUALIFIED DOCTORS</Typography.Text>
                                <Typography.Title className={cx('main-title')}>
                                ...
                                <List
                                    ...
                                    renderItem={(item) => (
                                        <List.Item className={cx('text')}>
                                            <Typography.Text>
                                                <FaDotCircle style={{ color: '#fff', verticalAlign: 'middle' }} />
                                            </Typography.Text>{' '}
                                            {item}
                                        </List.Item>
                                    )}
                            ...
                            >
                                <div className={cx('wrap-table-time')}>
                                    <div className={cx('table-time')}>
                                        <Typography.Title className={cx('big-title')}>Opening Hours :</Typography.Title>
                                        <Typography.Paragraph className={cx('text')}>
                                            Porta semper lacus cursus, feugiat primis ultrice ligula risus auctor tempus
                                            feugiat dolor lacinia cursus vitae massa
                                        </Typography.Paragraph>
                                        <table>
                                            <tbody>
                                                <tr>
                                        ...
                                        <Typography.Paragraph className={cx('text')}>
                                            Porta semper lacus cursus, feugiat primis ultrice lorem ligula risus auctor
                                            tempus feugiat dolor at lacinia undo cursus nulla massa suscipit, luctus
                    ...
                    <Col xs={22} sm={22} md={18} style={{ padding: '80px 0' }}>
                        <ul className={cx('list-tab')}>
                            {listTab.map((item) => (
                                <li
                                    key={item.id}
                                    className={cx('tab-item', `${item.id === idxTab ? 'active-tab' : ''}`)}
                        ...
                        {idxTab === 1 && <ContentTab data3={data3} data4={data4} img={pediatrics} title="Pediatrics" />}
                        {idxTab === 2 && <ContentTab data3={data3} data4={data4} img={hematology} title="Hematology" />}
                        {idxTab === 3 && <ContentTab data3={data3} data4={data4} img={mri2} title="MRI Diagnostic" />}
                        {idxTab === 4 && <ContentTab data3={data3} data4={data4} img={xRay} title="X-Ray Diagnostic" />}
                    </Col>
                </Row>
                ...
                <Row className={cx('banner')} justify="center">
                    <Col span={18}>
                        <div className={cx('wrap-text-banner')}>
                            <Typography.Title className={cx('title')} style={{ color: '#fff !important' }}>
                                Highest Quality Medical Treatment
                            </Typography.Title>
                            <Typography.Paragraph className={cx('text', 'bg')}>
                                Egestas magna egestas magna ipsum vitae purus ipsum primis cubilia lorem laoreet augue
